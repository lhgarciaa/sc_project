...
python src/run_louvain_row_col_ctx_mat.py -v $wh -i $row_column_input_csv -g $gamma -r1 -ns 1 -o $mod_dir/out-${SGE_TASK_ID}_m-${print_gamma}_runs-${num_runs}_$name_base
